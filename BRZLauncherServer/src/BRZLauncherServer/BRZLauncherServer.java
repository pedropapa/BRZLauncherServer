						                        ...
						                        case "entrarFila":
						                        	if(!jog.STATUS.equalsIgnoreCase("em_fila")) {
						                        		...
						                        		if(jog.bd_punicao <= timestamp) {
								                            ...
								                            output = json.toJson(tratar("funcao=filaStatus&MENSAGEM=Aguardando formação de partida..."));
						                        		} else {
						                        	...
						                        	if(servidorUtilizado != null) {
							    						...
							    						for(String j : jogs) {
							    			            	...
							    			            	if(!vjog.NICK.equalsIgnoreCase(jog.NICK)) {
					    										enviarParaCliente(vjog.sock, json.toJson(tratar("funcao=mensagem&MENSAGEM=O jogador "+jog.NICK+" cancelou sua participação na partida.")));
					    									}
							    						}
